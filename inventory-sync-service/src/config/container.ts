...
interface Container {
  readModelRepository: PrismaReadModelRepository
  handlers: Record<string, ProductCreatedHandler | StockAddedHandler | SaleCompletedHandler | StockTransferredHandler | BranchCreatedHandler>
}
